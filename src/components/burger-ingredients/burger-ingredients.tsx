...
//   const { buns, mains, sauces } = useSelector((state: { ingredients: TIngredientState }) => state.ingredients);
...
import { TTabMode, TIngredientState } from '../../utils/types';
import { BurgerIngredientsUI } from '../ui/burger-ingredients';
import { fetchIngredients, selectIngredients, selectIsLoading, selectHasError } from '../../services/slices/ingridientsSlice';
